...
- **Cadastro de usuário:** valida email único, hash de senha e retorna JWT.  
- **Login:** valida credenciais e retorna JWT.  
- **CRUD de tarefas:** criar, listar, atualizar e deletar tarefas associadas ao usuário autenticado.  
- **Segurança:**  
...
1. Usuário acessa a tela de cadastro ou login  
...
4. Todas as alterações são salvas no MongoDB e refletidas em tempo real no frontend  

## 🐳 Guia de Instalação e Execução com Docker

Clone o repositório:
      git clone https://github.com/Sacul-Lucas/desafio-cessUff-to-do-list.git
      cd Taskflow
